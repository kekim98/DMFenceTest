...
public class SimpleGeofence {
    ...
    /**
     * @param geofenceId The SimpleGeofence's request ID.
     * @param latitude Latitude of the SimpleGeofence's center in degrees.
     * @param longitude Longitude of the SimpleGeofence's center in degrees.
     * @param radius Radius of the geofence circle in meters.
     * @param expiration SimpleGeofence expiration duration.
     * @param transition Type of SimpleGeofence transition.
     */
    ...
    /**
     * Creates a Location Services SimpleGeofence object from a SimpleGeofence.
     * @return A SimpleGeofence object.
     */
